...
export const schema = z
  .object({
    firstName: z
      .string()
      .min(5, "FirstName should be 5 Characters Long")
      .max(255, "Max limit 255"),
    lastName: z
      .string()
      .min(5, "lastName should be 5 Characters Long")
    ...
    confirmPassword: z
      ...
      .min(5, "Password should be atleat 5 ch long")
      .max(50, "Max limit is 50"),
    location: z.string().max(255, "max limit is 255"),
    occupation: z.string().max(255, "max limit is 255"),
